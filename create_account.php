                   ...
                   <!-- Create hardware store responsible-->
                    <div class="modal-dialog modal-xl" role="document">
                         <div class="modal-content">
                               <div class="modal-header text-center border-0 bg-info">
                                   <div class="row">
                                        <div class="col-lg-4 col-md-4 col-ms-12">
                                            <img src="assets/images/boutique.jpg" class="rounded-circle" width="60px" height="60px">
                                         </div>
                                        <div class="col-lg-8 col-md-8 col-ms-12 text-center">
                                            <span class="modal-title  text-dark h4">
                                               Add User
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                             <div class="col-lg-12 text-left">
                                    <h5 class="text-bluesky mt-3">User identities</h5>
                            ...
                            <div class="col-lg-12 text-left">
                                    <h5 class="text-bluesky mt-3">User address</h5>
                                    <hr class="bg-gradient-primary">
                             </div>
                           ...
                           <!-- Email section  -->
                            ...
                            <div class="col-lg-12 text-left">
                                    <h5 class="text-bluesky mt-3">Info Locality</h5>
                                    <hr class="bg-gradient-primary">
                             </div>
