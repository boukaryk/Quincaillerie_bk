...
if(empty($search) && isset($categorie)){
      $req = $bdd->prepare('SELECT * FROM quincaillerie WHERE VILLE_QUINCAILLERIE=?  ORDER BY ID_QUINCAILLERIE DESC LIMIT 40');
        ...
        $count=$req->rowCount();
        if($count==0){
        $erreur='0 results found. Check the syntaxe of your search.';
        } 
    }
}  
?>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="text-info text-center">Hardware store of Burkina Faso</h4>
                    </div>
                </div>
            </div>
                <div class="card-body">
                    <div id="intr">
                        <p id="p"> Here you can see hardware store of Burkina Faso function to the city and sector. Chose a city and clic on "search". </p>
                            ...
                            <ul><?php
                                ...
                                <li>
                                    ...
                                    <div class="row">
                                       ...
                                       <h2 class="text-success text-right ville">city: <?= $an['VILLE_QUINCAILLERIE'];?></h2>
                                       
                                        
                                        <h2 class="text-success text-left secteur">Sector: <?= $an['SECTEUR_QUINCAILLERIE'];?></h2>              
                                       <!--  <a  class="text-center px-4 mx-3" href="<?= $an['NOM_DOMAIN'];?>?id_quinc=<?=$an['ID_QUINCAILLERIE']?>"> Visiter la</a>     -->   
                                        <a  class="text-center px-4 mx-3" href="entreprise.php?id_quinc=<?=$an['ID_QUINCAILLERIE']?>"> Visite it</a>                         
                                   </div>
