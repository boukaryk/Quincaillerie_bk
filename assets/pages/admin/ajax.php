...
//     $select_quinc=$bdd->prepare('SELECT * FROM quincairerie WHERE ID_QUINCAILLERIE=?,ID_QUINCAILLERIER=?,NOM_QUINCAILLERIE=?,VILLE_QUINCAILLERIE=?,SECTEUR_QUINCAILLERIE=?');

//     $select_quinc->execute([$code_quincaillerie,$code_quincaillerie,$nom_quincaillerie,$ville_quincaillerie,$secteur_quincaillerie]);
//         $count_quinc=$select_quinc->rowCount();
//         if($count==0){

//         $insert_quinc = $bdd->prepare("INSERT INTO quincaillerie SET ID_QUINCAILLERIE=?,ID_QUINCAILLERIER=?,NOM_QUINCAILLERIE=?,VILLE_QUINCAILLERIE=?,SECTEUR_QUINCAILLERIE=?");
//         $insert_quinc->execute([$code_quincaillerie,$code_quincaillerie,$nom_quincaillerie,$ville_quincaillerie,$secteur_quincaillerie]);
