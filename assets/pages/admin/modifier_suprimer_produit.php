            ...
            <div class="col-lg-12 py-3">
                <div class="card">
                    <div class="card-header">
                        <div class="row py-3">
                            <div class="col-6">
                                <h4 class="text-bluesky">All product</h4>
                            </div>
                            <div class="col-6 text-right">
                                <div class="col-4">
                                        <a class="btn btn-dark" role="button" href="ajouter_produit.php" title="Cliquer pour ajouter de produit" id="ajout">Add product
                                        </a>
                                </div>
                           </div>
                       </div>
                 <body>
                    <div class="card-body py-2">
                     <table class="table table-bordered table-hover table-responsive-lg table-responsive-md table-responsive-sm" id="table"> 
                        ...
                        <tbody>
                            <?php $update = 'update'; $delete = 'delete'; ?> <?php  while($affiches=$affiche->fetch()):?>
                                <tr>
