                                    ...
                                    <div class="modal-dialog modal-xl" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header bg-light">
                                                <h5 class="modal-title text-info text-uppercase">Editer  Info quincaillerie</h5>
...
<script type="text/javascript">
    ...
    function EnableDecimal(val1){
        if(val1.id=="nom_quincaillerie" || val1.id=="ville_quincaillerie" || val1.id=="secteur_quincaillerie" || val1.id=="status_quincaillerie" || val1.id=="image_quincaillerie"|| val1.id=="upd_nom_quincaillerie"|| val1.id=="upd_ville_quincaillerie"|| val1.id=="upd_secteur_quincaillerie"|| val1.id=="code_quincaillerie" || val1.id=="upd_code_quincaillerie"   ){
            if (val1.value =="")
            {
